 ...
 * on 2016-01-10 at 20:43:51 UTC 
 * Modify at your own risk.
 */

package com.udacity.gradle.backend.jokes.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getRandomJokeGCE".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link GetRandomJokeGCE#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public GetRandomJokeGCE getRandomJokeGCE() throws java.io.IOException {
    GetRandomJokeGCE result = new GetRandomJokeGCE();
    initialize(result);
    return result;
  }

  public class GetRandomJokeGCE extends MyApiRequest<com.udacity.gradle.backend.jokes.myApi.model.MyBean> {
     ...
     * parameters, call the {@link GetRandomJokeGCE#execute()} method to invoke the remote operation.
     * <p> {@link GetRandomJokeGCE#initialize(com.google.api.client.googleapis.services.AbstractGoogle
     * ClientRequest)} must be called to initialize this instance immediately after invoking the
     * constructor. </p>
     *
     * @since 1.13
     */
    protected GetRandomJokeGCE() {
      super(MyApi.this, "GET", REST_PATH, null, com.udacity.gradle.backend.jokes.myApi.model.MyBean.class);
    }
    ...
    @Override
    public GetRandomJokeGCE setAlt(java.lang.String alt) {
      return (GetRandomJokeGCE) super.setAlt(alt);
    }

    @Override
    public GetRandomJokeGCE setFields(java.lang.String fields) {
      return (GetRandomJokeGCE) super.setFields(fields);
    }

    @Override
    public GetRandomJokeGCE setKey(java.lang.String key) {
      return (GetRandomJokeGCE) super.setKey(key);
    }

    @Override
    public GetRandomJokeGCE setOauthToken(java.lang.String oauthToken) {
      return (GetRandomJokeGCE) super.setOauthToken(oauthToken);
    }

    @Override
    public GetRandomJokeGCE setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetRandomJokeGCE) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetRandomJokeGCE setQuotaUser(java.lang.String quotaUser) {
      return (GetRandomJokeGCE) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetRandomJokeGCE setUserIp(java.lang.String userIp) {
      return (GetRandomJokeGCE) super.setUserIp(userIp);
    }

    @Override
    public GetRandomJokeGCE set(String parameterName, Object value) {
      return (GetRandomJokeGCE) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.udacity.gradle.backend.jokes.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.udacity.gradle.backend.jokes.myApi.model.MyBean.class);
